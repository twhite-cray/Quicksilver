...
void EnergySpectrum::UpdateSpectrum(MonteCarlo* monteCarlo)
{
    ...
    ParticleVault* processing = monteCarlo->_particleVaultContainer->getTaskProcessingVault();
    ...
    ParticleVault* processed = monteCarlo->_particleVaultContainer->getTaskProcessedVault();
